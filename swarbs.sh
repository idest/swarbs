...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/idest/dotfiles.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/idest/swarbs/master/progs.csv"
...
getpass() { \
  ...
  exit ||
  # Otherwise prompts for a password.
...
finalize(){ \
	...
	dialog --title "All done!" --msgbox "Congrats! Provided there were no hidden errors, the script completed successfully and all the programs and configuration files should be in place.\\n\\nTo run the new graphical environment, log out and log back in as your new user, then run the command \"sway\" to start the graphical environment.\\n\\n.t Luke" 12 80
	}
...
# Get and verify password if user does not exist.
getpass || error "User exited."
